CREATE TABLE [etl].[tmp_load_1CE29AD2B2404978A042975BAE8A749B]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_1CE29AD2B2404978A042975BAE8A749B_ss] ON [etl].[tmp_load_1CE29AD2B2404978A042975BAE8A749B] ([SourceSystem], [SSID])
GO
