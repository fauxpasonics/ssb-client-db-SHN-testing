...
[ETL__SSID_AV_price_type_id] [nvarchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[PriceTypeGroup] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[AV_price_type_group] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
)
GO
ALTER TABLE [dbo].[DimPriceType] ADD CONSTRAINT [PK_dbo__DimPriceType] PRIMARY KEY CLUSTERED  ([DimPriceTypeId])
GO
