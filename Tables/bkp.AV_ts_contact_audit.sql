CREATE TABLE [bkp].[AV_ts_contact_audit]
(
[contact_audit_id] [uniqueidentifier] NULL,
[contact_birth_date] [datetime] NULL,
[contact_company] [nvarchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[contact_create_audit_id] [uniqueidentifier] NULL,
[contact_default_address_id] [uniqueidentifier] NULL,
...
[contact_parent_id] [uniqueidentifier] NULL,
...
[contact_version] [int] NULL,
[next_audit_id] [uniqueidentifier] NULL,
[contact_record_state] [int] NULL,
