CREATE TABLE [bkp].[AV_ts_customer]
(
[audit_datetime] [datetime] NULL,
[customer_record_state] [int] NOT NULL,
[customer_active_date] [datetime] NULL,
[customer_audit_id] [uniqueidentifier] NOT NULL,
[customer_class] [nvarchar] (40) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[customer_create_audit_id] [uniqueidentifier] NULL,
[customer_default_address_id] [uniqueidentifier] NULL,
[customer_default_contact_id] [uniqueidentifier] NULL,
[customer_id] [uniqueidentifier] NOT NULL,
[customer_keeper_customer_id] [uniqueidentifier] NULL,
[customer_duplicate_customer_id] [uniqueidentifier] NULL,
