...
[ETL__SSID_AV_season] [nvarchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL
)
GO
CREATE CLUSTERED COLUMNSTORE INDEX [CCI_dbo__DimSeason_V2] ON [dbo].[DimSeason_V2]
GO
