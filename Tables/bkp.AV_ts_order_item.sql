CREATE TABLE [bkp].[AV_ts_order_item]
(
...
[orderitem_audit_id] [uniqueidentifier] NOT NULL,
[orderitem_customerpass_id] [uniqueidentifier] NULL,
[orderitem_assigned_customerpass_id] [uniqueidentifier] NULL,
[orderitem_comment] [nvarchar] (512) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[orderitem_create_audit_id] [uniqueidentifier] NULL,
...
[orderitem_ticket_id] [uniqueidentifier] NULL,
[orderitem_bundle_id] [uniqueidentifier] NULL,
[orderitem_record_number] [int] NULL,
[orderitem_print_status] [int] NOT NULL,
[orderitem_print_count] [int] NULL,
[orderitem_order_id] [uniqueidentifier] NOT NULL,
[orderitem_rate_id] [uniqueidentifier] NULL,
[orderitem_type] [nvarchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[orderitem_version] [int] NOT NULL,
[orderitem_miscellaneous_item_id] [uniqueidentifier] NULL,
...
[orderitem_option_id] [uniqueidentifier] NULL,
[orderitem_customer_offer_id] [uniqueidentifier] NULL,
[orderitem_customer_id] [uniqueidentifier] NULL,
[orderitem_promo_code_id] [uniqueidentifier] NULL,
[orderitem_transaction_state] [int] NOT NULL,
[orderitem_agent_id] [uniqueidentifier] NULL,
[orderitem_order_bundle_id] [uniqueidentifier] NULL,
[orderitem_bundle_miscitem_id] [uniqueidentifier] NULL,
