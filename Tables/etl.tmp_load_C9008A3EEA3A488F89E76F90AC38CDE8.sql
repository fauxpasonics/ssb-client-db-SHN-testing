CREATE TABLE [etl].[tmp_load_C9008A3EEA3A488F89E76F90AC38CDE8]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_C9008A3EEA3A488F89E76F90AC38CDE8_ss] ON [etl].[tmp_load_C9008A3EEA3A488F89E76F90AC38CDE8] ([SourceSystem], [SSID])
GO
