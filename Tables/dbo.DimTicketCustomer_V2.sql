...
[ETL__SSID_AV_customer_id] [uniqueidentifier] NOT NULL,
[DimRepId] [int] NULL,
[IsCompany] [bit] NULL,
...
GO
ALTER TABLE [dbo].[DimTicketCustomer_V2] ADD CONSTRAINT [PK_DimTicketCustomer_V2] PRIMARY KEY CLUSTERED  ([DimTicketCustomerId])
GO
CREATE NONCLUSTERED INDEX [IX_ETL__DeltaHashKey] ON [dbo].[DimTicketCustomer_V2] ([ETL__DeltaHashKey])
GO
CREATE NONCLUSTERED INDEX [IX_ETL__IsDeleted] ON [dbo].[DimTicketCustomer_V2] ([ETL__IsDeleted])
GO
CREATE NONCLUSTERED INDEX [IX_ETL__SSID_AV_customer_id] ON [dbo].[DimTicketCustomer_V2] ([ETL__SSID_AV_customer_id]) INCLUDE ([ETL__SourceSystem])
GO
