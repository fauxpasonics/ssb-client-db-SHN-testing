...
[ETL__SSID_AV_sys_section] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[ETL__SSID_AV_sys_row] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[ETL__SSID_AV_sys_seat] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[ETL__SSID_AV_value_legend_id] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[ETL__SSID_AV_promo_code_id] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[ETL__SSID_AV_season] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[ETL__SSID_AV_order_id] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[ETL__SSID_AV_admission_id] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[AV_order_num] [int] NULL,
[AV_ticket_number] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[AV_ticket_barcode] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
ALTER TABLE [dbo].[FactTicketSales_V2] ADD CONSTRAINT [PK_FactTicketSales_V2_FactTicketSalesId] PRIMARY KEY CLUSTERED  ([FactTicketSalesId]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [NCIX_FactTicketSales_V2_DimTicketCustomerId_Include] ON [dbo].[FactTicketSales_V2] ([DimTicketCustomerId]) INCLUDE ([DimDateId]) WITH (DATA_COMPRESSION = PAGE)
GO
