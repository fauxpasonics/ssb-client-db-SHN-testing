CREATE TABLE [stg].[FILE__VR_CampaignRecipients]
(
...
GO
ALTER TABLE [stg].[FILE__VR_CampaignRecipients] ADD CONSTRAINT [PK__FILE__VR__C4EA2445C1C7D492] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
