...
[ETL__SSID_AV_activity] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
ALTER TABLE [dbo].[DimActivity] ADD CONSTRAINT [PK_dbo__DimActivity] PRIMARY KEY CLUSTERED  ([DimActivityId])
GO
