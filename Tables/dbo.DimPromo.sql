...
[ETL__SSID_AV_promo_code_id] [nvarchar] (25) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
ALTER TABLE [dbo].[DimPromo] ADD CONSTRAINT [PK_dbo__DimPromo] PRIMARY KEY CLUSTERED  ([DimPromoId])
GO
