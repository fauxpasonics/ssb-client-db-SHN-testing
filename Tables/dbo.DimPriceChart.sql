CREATE TABLE [dbo].[DimPriceChart]
(
...
[ETL__SSID_AV_price_chart_id] [int] NULL,
...
GO
ALTER TABLE [dbo].[DimPriceChart] ADD CONSTRAINT [PK_dbo__DimPriceChart] PRIMARY KEY CLUSTERED  ([DimPriceChartId])
GO
