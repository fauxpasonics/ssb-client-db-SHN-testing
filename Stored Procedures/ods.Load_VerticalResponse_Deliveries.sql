...
CREATE PROCEDURE [ods].[Load_VerticalResponse_Deliveries]
AS 
BEGIN
...
INTO #tmp
FROM ods.vw_VerticalResponse_Deliveries a --all bounces, includes new
LEFT JOIN ods.VerticalResponse_Deliveries b --materialized bounces
...
INSERT INTO ods.VerticalResponse_Deliveries (CampaignID, List_Name, Response_Type, Response_Date, EmailAddress, ETL__CreatedDate, ETL__UpdatedDate)
